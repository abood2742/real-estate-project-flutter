...
// import 'package:flutter/material.dart';
// import 'property_comment_rating_page.dart'; // تأكد من استيراد الصفحة
...
// class CommentsOnPropertyPage extends StatefulWidget {
//   const CommentsOnPropertyPage({super.key});

//   @override
//   State<CommentsOnPropertyPage> createState() => _ClientCommentsState();
// }

// class _ClientCommentsState extends State<CommentsOnPropertyPage> {
//   final List<Review> reviews = [];
...
//       context,
//       MaterialPageRoute(builder: (_) => const PropertyCommentRatingPage()),
//     );
...
class CommentsOnPropertyPage extends StatelessWidget {
  const CommentsOnPropertyPage({super.key});
