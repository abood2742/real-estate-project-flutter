...
class SubscriptionsOfficePage extends StatefulWidget {
  ...
  @override
  State<SubscriptionsOfficePage> createState() => _SubscriptionsOfficePageState();
}

class _SubscriptionsOfficePageState extends State<SubscriptionsOfficePage> {
  int selectedPlan = -1; // -1 = no plan
  final AllSubscriptionsService _service = AllSubscriptionsService();
  List<AllSubscriptionModel> subscriptions = [];
  bool isLoading = true;
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              localizations.translate('payment_plan'),
            ...
            Expanded(
              child: isLoading
                  ...
                  : subscriptions.isEmpty
                      ? Center(
                          child: Text(
                            localizations.translate('no_properties_available'),
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return SubscriptionCard(
                              ...
                              numberOfProperty: sub.maxProperties.toString(),
                              numberOfPromotions: sub.maxPromotions.toString(),
                              period: localizations.translate(sub.period.toLowerCase()),
                            );
                          },
                        ),
            ),
            ...
            Center(
              child: ElevatedButton(
                ...
                child: Text(
                  ...
                  style: const TextStyle(fontSize: 18, fontFamily: 'Pacifico'),
                ),
              ),
            ),
            const SizedBox(height: 20),
  ...
  IconData _getIconForPlan(int index) {
    switch (index) {
      case 0:
