...
class _OfficeDetailesPageState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('معلومات المكتب',style: TextStyle(color: Colors.white,fontFamily: 'Pacifico'),),
        actions: [
  ...
  Widget _buildInfoCard(IconData icon, String title, String subtitle) {
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(title, style: const TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Pacifico,',color: Color.fromARGB(255, 64, 41, 195))),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // ),
          Row(children: [
            CustomButon(text: 'عرض صورة الترخيص',onTap:  () {
              showDialog(
                 context: context,
                 builder: (_) => Dialog(
                   child: Image.network(officeDetailsModel!.licensePhoto.url),
            ...
            SizedBox(width: 10),
            CustomButon(text: 'إضافة تعليق وتقييم',onTap:  () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => AddCommentAndRatingPage(officeId: widget.officeId,),
          ...
          //   label: const Text('عرض كل التعليقات'),
          // ),
           CustomButon(text: 'عرض كل التعليقات',onTap:  () {
             Navigator.push(
                 context,
                 MaterialPageRoute(
                   builder: (_) => CommentsPage(officeId: officeDetailsModel!.id,),
