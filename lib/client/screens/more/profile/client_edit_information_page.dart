...
//       if (args != null && args is ClientInfoModel) {
//         product = args;

//         firstNameController = TextEditingController(text: product!.firstName);
//         lastNameController = TextEditingController(text: product!.lastName);
//         receiverIdentifierController =
//             TextEditingController(text: product!.receiverIdentifier);
//         profilePhotoController =
//             TextEditingController(text: product!.profilePhoto);
//       }
//       _initialized = true;
//     }
//   }
...
//                     try {
//                       final updatedModel = await updateInfo().updateClientInfo(
...
//   UpdateProductService updateInfo() => UpdateProductService();
// }
import 'package:flutter/material.dart';
import 'package:modal_progress_hud_nsn/modal_progress_hud_nsn.dart';
import 'package:property_system/client/components/Custom_textField.dart';
