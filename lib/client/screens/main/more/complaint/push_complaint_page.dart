...
// // //   Future<void> _submitComplaint() async {
// // //     if (titleController.text.isEmpty) {
// // //       _showSnack(localizations.translate('enter_complaint_title'), const Color.fromARGB(255, 152, 54, 244));
// // //       return;
// // //     }

// // //     if (descriptionController.text.isEmpty) {
// // //       _showSnack(localizations.translate('enter_complaint_content'), const Color.fromARGB(255, 152, 54, 244));
// // //       return;
// // //     }
...
// // //         await PropertyComplaintService().createComplaint(complaint, photos);
// // //       }
// // //       _showSnack(localizations.translate('complaint_submitted_success'), Colors.green);

// // //       Navigator.pop(context);
// // //     } catch (e) {
// // //       _showSnack(localizations.translate('complaint_submission_failed') + ': $e', Colors.red);
// // //     } finally {
// // //       setState(() {
// // //         _isLoading = false;
// // //       });
...
// // //                       style: const TextStyle(color: Colors.black),
// // //                       decoration: InputDecoration(
// // //                         hintText: localizations.translate('enter_complaint_reason'),
// // //                         hintStyle: const TextStyle(color: Colors.grey),
// // //                         filled: true,
// // //                         fillColor: Colors.grey[200],
// // //                         border: OutlineInputBorder(
...
// // //                         Expanded(
// // //                           child: CustomButton(
// // //                             text: localizations.translate('submit_complaint_button'),
// // //                             onTap: _submitComplaint,
// // //                           ),
// // //                         ),
// // //                       ],
...
class _PushComplaintPageState extends State<PushComplaintPage> {
  ...
  Future<void> _submitComplaint(BuildContext context) async {
    final localizations = AppLocalizations.of(context)!;
    if (titleController.text.isEmpty) {
      _showSnack(context, localizations.translate('enter_complaint_title'), const Color.fromARGB(255, 152, 54, 244));
      return;
    }

    if (descriptionController.text.isEmpty) {
      _showSnack(context, localizations.translate('enter_complaint_content'), const Color.fromARGB(255, 152, 54, 244));
      return;
    }
    ...
    try {
      ...
      _showSnack(context, localizations.translate('complaint_submitted_success'), Colors.green);

      Navigator.pop(context);
    } catch (e) {
      _showSnack(context, localizations.translate('complaint_submission_failed') + ': $e', Colors.red);
    } finally {
      setState(() {
        _isLoading = false;
      });
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: CustomButton(
                            text: localizations.translate('submit_complaint_button'),
                            onTap: () => _submitComplaint(context),
                          ),
                        ),
                      ],
                    ),
