...
class ClientUserPropertyComplainetCase2 extends StatelessWidget {
  ...
  ClientUserPropertyComplainetCase2({
    super.key,
    required this.complaint,
    required this.title,
    required this.contained,
                    ...
                    children: [
                      Text(
                        ...
                        style: Theme.of(context)
                            .textTheme
                            .titleLarge!
                            .copyWith(color: const Color.fromARGB(255, 18, 48, 131)),
                      ),
                      const SizedBox(height: 12),
                      Text("العنوان: $title,"),
                      Text("المحتوى: $contained,"),
                    ...
                    children: [
                      Text(
                        ...
                        style: Theme.of(context)
                            .textTheme
                            .titleLarge!
                            .copyWith(color: const Color.fromARGB(255, 25, 61, 130)),
                      ),
                      const SizedBox(height: 12),
                      Text("الإسم: $name,"),
                      Text("البريد: $post"),
        ...
        children: [
          ...
          Positioned(
            ...
            child: FloatingActionButton.extended(
              ...
              icon: const Icon(Icons.home, color: Colors.white), // أيقونة للعقار
              label: Text(
