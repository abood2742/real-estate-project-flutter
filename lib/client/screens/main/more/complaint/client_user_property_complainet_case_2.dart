...
class ClientUserPropertyComplainetCase2 extends StatelessWidget {
  final GetCase2ComplainetModel complaint;

  const ClientUserPropertyComplainetCase2({
    super.key,
  ...
  Widget build(BuildContext context) {
    OfficeOfProperty office = complaint.propertyModel.office;

    final property = complaint.propertyModel; // افتراض بيانات العقار
    final List<PropertyComplaintPhoto> photos = complaint.propertyComplaintPhotos;
        ...
        children: [
            ...
            child: FloatingActionButton.extended(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) =>
                        OfficeDetailsPage(officeId: office.officeId),
                  ),
                );
              },
          ...
          Positioned(
            ...
            child: FloatingActionButton.extended(
              ...
              icon:
                  const Icon(Icons.home, color: Colors.white), // أيقونة للعقار
              label: Text(
